...
const writeups = [
  {
    ...
    text: 'Sprintz Holdings Pte. Ltd. is presented as a professional Singapore-based international trading company supporting structured supply opportunities across Asia, the Middle East, and broader global markets. The website positioning is designed to communicate credibility, responsiveness, and disciplined trade support in a manner aligned with reputable cross-border trading groups.',
  },
  {
    title: 'Market Footprint',
    text: 'The business profile is framed to support enquiries and relationships spanning Singapore, Malaysia, Thailand, China, the UAE, the USA, Indonesia, Vietnam, India, and other strategic regional corridors. This broader market narrative gives Sprintz a more established corporate presence for counterparties evaluating sourcing and trade collaboration.',
  },
  {
    title: 'Commercial Focus',
    text: 'Sprintz is positioned around commodities, energy products, industrial supply, aviation equipment, medical consumables, and project procurement. The revised language emphasizes corporate discipline, partner coordination, and practical execution support rather than a simple product-listing website approach.',
  },
]
...
export default function App() {
  ...
  function handleSubmit() {
    setStatus({
      type: 'info',
      text: 'Your enquiry will be sent securely through the website form. Replace the Formspree endpoint in src/App.jsx with your live form URL before deployment.',
    })
  }
        ...
        <div className="container contact-grid">
          ...
          <form className="contact-form" action={formAction} method="POST" onSubmit={handleSubmit}>
            ...
            <div className="form-actions">
              ...
              <a className="btn btn-secondary-dark" href={whatsappHref} target="_blank" rel="noreferrer">WhatsApp Us</a>
            </div>
          </form>
        </div>
      </section>
